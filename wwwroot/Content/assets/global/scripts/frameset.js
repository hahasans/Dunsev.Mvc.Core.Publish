...
var xmlData = XMLData("tr_dosyalar/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='Bu tablo şekil ayrıntılarını içerir'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>Etiket</TH><TH>Değer</TH></THEAD>";
	...
	if (shapeNode != null)
	{
		...
		{
			strCPHTML = "Kullanılabilir Ayrıntı Yok.";
		}
	}
